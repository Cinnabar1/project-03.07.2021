    ...
    public partial class Form1 : Form
    {
        ...
        private void ButtonDownErrors_Click(object sender, EventArgs e)
        {
            ...
            if (dtpBegin.Value < dtpEnd.Value)
            {
                ...
                string connectionString1 = "Server=" + Properties.Settings.Default.serverAddress + ";Database=" + Properties.Settings.Default.dbname + ";UserId=" + Properties.Settings.Default.login + ";Password=" + Properties.Settings.Default.password + ";Trusted_Connection=True;";
